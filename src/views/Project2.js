        ...
        <Grid pt={8} xs={12} container justifyContent="center">
          ...
          <Grid item xs={8}>
            <Typography align="center" color="text.secondary">
              Note: These files are currently in progress and constantly
              changing. If one of the buttons below is disbled then the document
              is currently not avalible for viewing.
            </Typography>
          </Grid>
